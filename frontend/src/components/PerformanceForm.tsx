...
const PerformanceForm: React.FC<PerformanceFormProps> = ({
	...
	const canChooseMatch = useMemo(
		() => (matchId == null ? true : false),
		[matchId],
	);
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			await performanceService.createPerformance(selectedMatchId, {
				playerId,
				goals,
				assists,
				rating,
	...
	return (
		...
		>
			...
			{errorMessage ? (
				<div style={{ marginBottom: "10px", color: "#b00020" }}>
					{errorMessage}
				</div>
			) : null}
			<div style={{ marginBottom: "10px" }}>
				...
				<div
					style={{
						marginTop: canChooseMatch ? "10px" : 0,
						marginBottom: "8px",
						fontSize: "14px",
						color: "#444",
					}}
